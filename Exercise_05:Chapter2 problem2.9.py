...
class adia_drag_cannon(cannon):
    def next_state(self, current_state):
        ...
        pass
a1 = adia_drag_cannon(flight_state(0,0,573.4,401.2,0),_dt=0.1)
a2 = adia_drag_cannon(flight_state(0,0,536.2,449.9,0),_dt=0.1)
a3 = adia_drag_cannon(flight_state(0,0,494.9,494.9,0),_dt=0.1)
a4 = adia_drag_cannon(flight_state(0,0,449.9,536.2,0),_dt=0.1)
a5 = cannon(flight_state(0,0,401.5,573.4,0),_dt=0.1)
a1.shoot()
a2.shoot()
a3.shoot()
a4.shoot()
